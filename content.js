...
function createSpeedControl() {
  ...
  const speedButton = speedControl.querySelector('.atvwebplayersdk-speedcontrol-button');
  ...
  speedMenu.querySelectorAll('.atvwebplayersdk-speedoption-container').forEach((option, index) => {
    option.addEventListener('click', function (e) {
      ...
      updateSpeedMenuVisual(this);
    });
  });

  updateSpeedMenuVisual(speedMenu.querySelectorAll('.atvwebplayersdk-speedoption-container')[1]);
...
function updateSpeedMenuVisual(selectedOption) {
  ...
  console.log('speed', speedMenu.querySelectorAll('.atvwebplayersdk-speedoption-container'));
  if (speedMenu) {
    ...
    selectedOption.querySelector('div').classList.add('f1bhki25');
    selectedOption.querySelector('label').classList.add('f1f4ffwn');
  }
}
...
function addSpeedControl(container) {
  if (
    ...
    !container.querySelector('.atvwebplayersdk-speedcontrol-button')
  ) {
